...
There is a strong ATOM staker consensus around [Proposal 19](https://hubble.figment.network/cosmos/chains/cosmoshub-2/governance/proposals/19), [Cosmos Hub 3 Upgrade Proposal E](https://ipfs.io/ipfs/QmfJyd64srJSX824WoNnF6BbvF4wvPGqVBynZeN98C7ygq) on `cosmoshub-2`.
This indicates that the upgrade procedure should be performed on or around December 11, 2019 at Block Height 2,902,000.
...
- The upgrade height as agreed upon by governance: **2902000**
...
6. Migrate exported state from the current v0.34.6+ version to the new v2.0.3 version:
   ...
   **NOTE**: The `migrate` command takes an input genesis state and migrates it to a targeted version.
   ...
   Genesis time should be computed relative to the blocktime of 2902000. The genesis time shall be
   the blocktime of 2902000 + 60 minutes with the subseconds truncated.
